 ...
 */
public class OasInvalidHeaderStyleRule extends OasInvalidPropertyValueRule {
    ...
    public void visitHeader(OasHeader node) {
        ...
        if (hasValue(header.style)) {
            this.reportIfInvalid(isValidEnumItem(header.style, array("simple")), node, Constants.PROP_STYLE, map());
        }
    }
