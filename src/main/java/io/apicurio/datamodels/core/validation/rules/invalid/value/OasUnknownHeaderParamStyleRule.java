 ...
 */
public class OasUnknownHeaderParamStyleRule extends OasInvalidPropertyValueRule {

    /**
     * Constructor.
     * @param ruleInfo
     */
    public OasUnknownHeaderParamStyleRule(ValidationRuleMetaData ruleInfo) {
        super(ruleInfo);
    }
    ...
    public void visitParameter(Parameter node) {
        ...
        if (hasValue(param.style)) {
            if (equals(param.in, "header")) {
                this.reportIfInvalid(isValidEnumItem(param.style, array("simple")), node, Constants.PROP_STYLE, map("style", param.style));
            }
        }
    }
