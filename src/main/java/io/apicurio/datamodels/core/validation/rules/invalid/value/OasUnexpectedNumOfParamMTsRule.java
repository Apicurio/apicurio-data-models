 ...
 */
public class OasUnexpectedNumOfParamMTsRule extends OasInvalidPropertyValueRule {
    ...
    public void visitParameter(Parameter node) {
        ...
        if (hasValue(param.content)) {
            this.reportIfInvalid(param.getMediaTypes().size() < 2, node, Constants.PROP_CONTENT, map());
        }
    }
