 ...
 */
public class OasUnknownPathParamStyleRule extends OasInvalidPropertyValueRule {
    ...
    public void visitParameter(Parameter node) {
        ...
        if (equals(param.in, "path")) {
            if (hasValue(param.style)) {
                this.reportIfInvalid(isValidEnumItem(param.style, array("matrix", "label", "simple")), param, 
                        Constants.PROP_STYLE, map("style", param.style));
            }
        }
    }
