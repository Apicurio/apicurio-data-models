...
import io.apicurio.datamodels.core.validation.rules.invalid.format.OasInvalidApiDescriptionRule;
import io.apicurio.datamodels.core.validation.rules.invalid.format.OasInvalidApiHostRule;
import io.apicurio.datamodels.core.validation.rules.invalid.format.OasInvalidContactEmailRule;
import io.apicurio.datamodels.core.validation.rules.invalid.format.OasInvalidContactUrlRule;
...
import io.apicurio.datamodels.core.validation.rules.invalid.format.OasInvalidLicenseUrlRule;
...
import io.apicurio.datamodels.core.validation.rules.invalid.format.OasInvalidServerDescriptionRule;
import io.apicurio.datamodels.core.validation.rules.invalid.format.OasInvalidServerUrlRule;
...
import io.apicurio.datamodels.core.validation.rules.invalid.format.OasInvalidTermsOfServiceUrlRule;
...
import io.apicurio.datamodels.core.validation.rules.required.OasMissingLicenseNameRule;
...
import io.apicurio.datamodels.core.validation.rules.required.OasMissingServerTemplateUrlRule;
...
public class ValidationRuleSet {
    ...
    public ValidationRuleSet() {
        ...
        this.rules.add(md("INF-003", "Invalid API Description", "Invalid Property Format", "Info", new DocumentType[] { oai20, oai30 }, true, "API description is an incorrect format.", OasInvalidApiDescriptionRule.class));
        this.rules.add(md("INF-004", "Invalid Terms of Service URL", "Invalid Property Format", "Info", new DocumentType[] { oai30 }, true, "Terms of Service URL is an incorrect format.", OasInvalidTermsOfServiceUrlRule.class));
        this.rules.add(md("CTC-001", "Invalid Contact URL", "Invalid Property Format", "Contact", new DocumentType[] { oai20, oai30 }, true, "Contact URL is an incorrect format.", OasInvalidContactUrlRule.class));
        this.rules.add(md("CTC-002", "Invalid Contact Email", "Invalid Property Format", "Contact", new DocumentType[] { oai20, oai30 }, true, "Contact Email is an incorrect format.", OasInvalidContactEmailRule.class));
        this.rules.add(md("LIC-002", "Invalid License URL", "Invalid Property Format", "License", new DocumentType[] { oai20, oai30 }, true, "License URL is an incorrect format.", OasInvalidLicenseUrlRule.class));
        ...
        this.rules.add(md("SRV-003", "Invalid Server Description", "Invalid Property Format", "Server", new DocumentType[] { oai30 }, true, "Server Description is an incorrect format.", OasInvalidServerDescriptionRule.class));
        this.rules.add(md("SRV-002", "Invalid Server URL", "Invalid Property Format", "Server", new DocumentType[] { oai30 }, true, "Server URL is an incorrect format.", OasInvalidServerUrlRule.class));
        ...
        this.rules.add(md("SRV-001", "Missing Server Template URL", "Required Property", "Server", new DocumentType[] { oai30 }, true, "Server is missing a template URL.", OasMissingServerTemplateUrlRule.class));
