 ...
 */
public class OasInvalidApiProducesMTRule extends OasInvalidPropertyValueRule {
    /**
     * Constructor.
     * @param ruleInfo
     */
    ...
    public void visitDocument(Document node) {
        ...
        if (hasValue(doc.produces)) {
            this.reportIfInvalid(isValidMimeType(doc.produces), node, Constants.PROP_PRODUCES, map());
        }
    }
