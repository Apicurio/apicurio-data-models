 ...
 */
public class AaiInvalidOperationTraitReferenceRule extends ValidationRule {

    /**
     * Constructor.
     * @param ruleInfo
     */
    public AaiInvalidOperationTraitReferenceRule(ValidationRuleMetaData ruleInfo) {
        super(ruleInfo);
    }
