 ...
 */
public class OasUnknownCookieParamStyleRule extends OasInvalidPropertyValueRule {

    /**
     * Constructor.
     * @param ruleInfo
     */
    public OasUnknownCookieParamStyleRule(ValidationRuleMetaData ruleInfo) {
        super(ruleInfo);
    }
    ...
    public void visitParameter(Parameter node) {
        ...
        if (hasValue(param.style)) {
            if (equals(param.in, "cookie")) {
                this.reportIfInvalid(isValidEnumItem(param.style, array("form")), node, Constants.PROP_STYLE, 
                        map("style", param.style));
            }
        }
    }
    /**
