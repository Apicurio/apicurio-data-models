 ...
 */
public class OasUnexpectedParamCollectionFormatRule extends OasInvalidPropertyValueRule {

    /**
     * Constructor.
     * @param ruleInfo
     */
    public OasUnexpectedParamCollectionFormatRule(ValidationRuleMetaData ruleInfo) {
        super(ruleInfo);
    }
    ...
    public void visitParameter(Parameter node) {
        ...
        if (hasValue(param.collectionFormat)) {
            this.reportIfInvalid(equals(param.type, "array"), node, Constants.PROP_COLLECTION_FORMAT, map());
        }
    }
