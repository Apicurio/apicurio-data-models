 ...
 */
public class OasMissingItemsArrayInformationRule extends OasRequiredPropertyValidationRule {

    /**
     * Constructor.
     * @param ruleInfo
     */
    public OasMissingItemsArrayInformationRule(ValidationRuleMetaData ruleInfo) {
        super(ruleInfo);
    }
