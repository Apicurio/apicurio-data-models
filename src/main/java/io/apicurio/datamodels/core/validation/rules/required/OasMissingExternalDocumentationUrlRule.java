 ...
 */
public class OasMissingExternalDocumentationUrlRule extends OasRequiredPropertyValidationRule {

    /**
     * Constructor.
     * @param ruleInfo
     */
    public OasMissingExternalDocumentationUrlRule(ValidationRuleMetaData ruleInfo) {
        super(ruleInfo);
    }
