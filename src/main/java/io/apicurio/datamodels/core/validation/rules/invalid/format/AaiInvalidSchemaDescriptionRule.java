...
/**
 * Implements the Invalid Schema Description Rule
 * @author eric.wittmann@gmail.com
 */
public class AaiInvalidSchemaDescriptionRule extends ValidationRule {

    /**
     * Constructor.
     * @param ruleInfo
     */
    public AaiInvalidSchemaDescriptionRule(ValidationRuleMetaData ruleInfo) {
        super(ruleInfo);
    }
    ...
    public void visitSchema(Schema node) {
        ...
        if (hasValue(schema.description)) {
            this.reportIfInvalid(isValidGFM(schema.description), node, Constants.PROP_DESCRIPTION, map());
        }
    }
