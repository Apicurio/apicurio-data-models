...
/**
 * Implements the Invalid Channel Item Reference rule.
 * @author eric.wittmann@gmail.com
 */
public class AaiInvalidChannelItemReferenceRule extends ValidationRule {

    /**
     * Constructor.
     * @param ruleInfo
     */
    public AaiInvalidChannelItemReferenceRule(ValidationRuleMetaData ruleInfo) {
        super(ruleInfo);
    }
