 ...
 */
public class OasUnknownParamStyleRule extends OasInvalidPropertyValueRule {
    ...
    public void visitParameter(Parameter node) {
        ...
        if (hasValue(param.style)) {
            this.reportIfInvalid(isValidEnumItem(param.style, array("matrix", "label", "form", "simple", "spaceDelimited", "pipeDelimited", "deepObject")), 
                    node, Constants.PROP_STYLE, map("style", param.style));
        }
    }
