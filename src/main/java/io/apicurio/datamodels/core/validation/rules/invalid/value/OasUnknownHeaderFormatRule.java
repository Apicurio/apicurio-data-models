 ...
 */
public class OasUnknownHeaderFormatRule extends OasInvalidPropertyValueRule {
    ...
    public void visitHeader(OasHeader node) {
        ...
        if (hasValue(header.format)) {
            this.reportIfInvalid(isValidEnumItem(header.format, array("int32", "int64", "float", "double", "byte", "binary", "date", "date-time", "password")), 
