...
/**
 * Implements the Invalid Channel Item Description Rule
 * @author eric.wittmann@gmail.com
 */
public class AaiInvalidChannelItemDescriptionRule extends ValidationRule {

    /**
     * Constructor.
     * @param ruleInfo
     */
    public AaiInvalidChannelItemDescriptionRule(ValidationRuleMetaData ruleInfo) {
        super(ruleInfo);
    }
