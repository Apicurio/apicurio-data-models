...
public class CommandFactory {
    ...
    public static ICommand create(String cmdType) {
        switch (cmdType) {
            ...
            case "ReplaceCorrelationIdCommand":
            { return new ReplaceCorrelationIdCommand(); }
    ...
    public static final ICommand createReplaceCorrelationIdCommand(AaiCorrelationId old, AaiCorrelationId replacement) {
        return new ReplaceCorrelationIdCommand(old, replacement);
    }
