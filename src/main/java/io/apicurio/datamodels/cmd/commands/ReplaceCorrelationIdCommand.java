...
/**
 * A command used to replace a correlation id with a newer version.
 */
public class ReplaceCorrelationIdCommand extends ReplaceNodeCommand<AaiCorrelationId> {

    public String _correlationIdName;

    ReplaceCorrelationIdCommand() {
    }

    ReplaceCorrelationIdCommand(AaiCorrelationId old, AaiCorrelationId replacement) {
