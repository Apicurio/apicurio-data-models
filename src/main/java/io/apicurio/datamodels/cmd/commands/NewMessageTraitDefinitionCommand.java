...
/**
 * A command used to create a new message trait definition item in aa AsyncAPI document.
 * @author laurent.broudoux@gmail.com
 */
public class NewMessageTraitDefinitionCommand extends AbstractCommand {
   ...
   public NewMessageTraitDefinitionCommand() {
   }

   public NewMessageTraitDefinitionCommand(String newName, String newDescription) {
   ...
   public void undo(Document document) {
      LoggerCompat.info("[NewMessageTraitDefinitionCommand] Reverting.");
      ...
      doc20.components.removeMessageTraitDefinition(this._newName);
   }
}
