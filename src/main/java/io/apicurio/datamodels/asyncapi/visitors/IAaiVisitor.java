...
public interface IAaiVisitor extends IVisitor {
    ...
    void visitAllOfSchema(Schema node);
    void visitOneOfSchema(Schema node);
    void visitAnyOfSchema(Schema node);
    void visitNotSchema(Schema node);
    void visitItemsSchema(Schema node);
    void visitAdditionalPropertiesSchema(Schema node);
