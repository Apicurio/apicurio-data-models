...
public abstract class AaiChannelBindingsDefinition extends AaiChannelBindings implements IDefinition {
     ...
     * Constructor.
     */
    public AaiChannelBindingsDefinition(String name) {
        super();
        this._name = name;
    }
     ...
     * @param parent
     */
    public AaiChannelBindingsDefinition(Node parent) {
        super(parent);
    }
     ...
     * @param name
     */
    public AaiChannelBindingsDefinition(Node parent, String name) {
        super(parent);
        this._name = name;
    }
    ...
    public void accept(IVisitor visitor) {
        ...
        viz.visitChannelBindingsDefinition(this);
    }
