...
public class Oas30ResponseDefinition extends Oas30Response implements IDefinition {
     ...
     * @param statusCode
     */
    public Oas30ResponseDefinition(String statusCode) {
        super(statusCode);
    }
    
    /**
     * @see io.apicurio.datamodels.openapi.models.OasResponse#accept(io.apicurio.datamodels.core.visitors.IVisitor)
     */
    @Override
