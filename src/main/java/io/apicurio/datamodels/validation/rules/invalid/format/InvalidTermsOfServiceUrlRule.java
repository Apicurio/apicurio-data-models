...
public class InvalidTermsOfServiceUrlRule extends ValidationRule {
    ...
    /**
     * @see io.apicurio.datamodels.models.visitors.CombinedVisitorAdapter#visitInfo(io.apicurio.datamodels.models.Info)
     */
    @Override
    public void visitInfo(Info node) {
        if (hasValue(node.getTermsOfService())) {
            this.reportIfInvalid(isValidUrl(node.getTermsOfService()), node, "termsOfService", map());
        }
    }
