...
/**
 * Implements the Invalid Example Pairing Reference rule for OpenRPC.
 * @author eric.wittmann@gmail.com
 */
public class OrpcInvalidExamplePairingReferenceRule extends ValidationRule {

    /**
     * Constructor.
     * @param ruleInfo
     */
    public OrpcInvalidExamplePairingReferenceRule(ValidationRuleMetaData ruleInfo) {
        super(ruleInfo);
    }
