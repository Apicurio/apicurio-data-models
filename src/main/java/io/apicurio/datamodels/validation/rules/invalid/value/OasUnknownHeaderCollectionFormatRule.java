 ...
 */
public class OasUnknownHeaderCollectionFormatRule extends AbstractInvalidPropertyValueRule {
    ...
    public void visitHeader(OpenApiHeader node) {
        ...
        if (hasValue(header.getCollectionFormat())) {
            this.reportIfInvalid(isValidEnumItem(header.getCollectionFormat(), array("csv", "ssv", "tsv", "pipes")), node,
