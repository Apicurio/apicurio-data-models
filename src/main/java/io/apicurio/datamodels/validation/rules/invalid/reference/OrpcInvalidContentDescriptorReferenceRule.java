...
/**
 * Implements the Invalid Content Descriptor Reference rule for OpenRPC.
 * @author eric.wittmann@gmail.com
 */
public class OrpcInvalidContentDescriptorReferenceRule extends ValidationRule {

    /**
     * Constructor.
     * @param ruleInfo
     */
    public OrpcInvalidContentDescriptorReferenceRule(ValidationRuleMetaData ruleInfo) {
        super(ruleInfo);
    }
