 ...
 */
public class OasUnexpectedParamCollectionFormatRule extends AbstractInvalidPropertyValueRule {
    ...
    public void visitParameter(Parameter node) {
        ...
        if (hasValue(param.getCollectionFormat())) {
            this.reportIfInvalid(equals(param.getType(), "array"), node, "collectionFormat", map());
        }
    }
