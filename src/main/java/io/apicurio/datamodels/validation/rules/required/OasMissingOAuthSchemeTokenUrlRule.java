...
public class OasMissingOAuthSchemeTokenUrlRule extends RequiredPropertyValidationRule {
    ...
    public void visitSecurityScheme(SecurityScheme node) {
        if (equals(node.getType(), "oauth2")) {
            ...
            if ((equals(scheme.getFlow(), "password") || equals(scheme.getFlow(), "application") || equals(scheme.getFlow(), "accessCode")) && !isDefined(scheme.getTokenUrl())) {
                this.report(scheme, "tokenUrl", map());
            }
        }
    }
