...
public class ValidationRuleSet {
    ...
    public ValidationRuleSet() {
        ...
        this.rules.add(md("PAR-010", "Invalid Parameter Description", "Invalid Property Format", "Parameter", new ModelType[]{ModelType.OPENAPI20, ModelType.OPENAPI30, ModelType.OPENAPI31}, true, "Parameter Description is an incorrect format.", InvalidParameterDescriptionRule.class));
        ...
        this.rules.add(md("PAR-018", "Invalid Parameter Reference", "Invalid Reference", "Parameter", new ModelType[]{ModelType.OPENAPI20, ModelType.OPENAPI30, ModelType.OPENAPI31, ModelType.ASYNCAPI20, ModelType.ASYNCAPI21, ModelType.ASYNCAPI22, ModelType.ASYNCAPI23, ModelType.ASYNCAPI24, ModelType.ASYNCAPI25, ModelType.ASYNCAPI26, ModelType.ASYNCAPI30}, true, "Parameter Reference must refer to a valid Parameter Definition.", InvalidParameterReferenceRule.class));
        ...
        this.rules.add(md("SS-018", "Invalid Security Scheme Reference", "Invalid Reference", "Security Scheme", new ModelType[]{ModelType.OPENAPI30, ModelType.OPENAPI31, ModelType.ASYNCAPI20, ModelType.ASYNCAPI21, ModelType.ASYNCAPI22, ModelType.ASYNCAPI23, ModelType.ASYNCAPI24, ModelType.ASYNCAPI25, ModelType.ASYNCAPI26, ModelType.ASYNCAPI30}, true, "Security Scheme Reference must refer to a valid Security Scheme Definition.", InvalidSecuritySchemeReferenceRule.class));
        ...
        this.rules.add(md("R-002", "Missing API Information", "Required Property", "API", new ModelType[]{ModelType.OPENAPI20, ModelType.OPENAPI30, ModelType.OPENAPI31}, true, "API is missing the 'info' property.", MissingApiInformationRule.class));
