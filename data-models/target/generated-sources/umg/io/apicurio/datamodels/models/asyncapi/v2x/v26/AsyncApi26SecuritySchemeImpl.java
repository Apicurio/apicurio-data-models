...
public class AsyncApi26SecuritySchemeImpl extends NodeImpl implements AsyncApi26SecurityScheme {
	...
	@Override
	public AsyncApi26OAuthFlows createOAuthFlows() {
		AsyncApi26OAuthFlowsImpl node = new AsyncApi26OAuthFlowsImpl();
		node.setParent(this);
		return node;
	}
	...
	public Node emptyClone() {
		return new AsyncApi26SecuritySchemeImpl();
	}
}