...
public class OpenApi32ComponentsImpl extends NodeImpl implements OpenApi32Components {
	...
	private Map<String, OpenApi32PathItem> pathItems;
	private Map<String, OpenApi32MediaType> mediaTypes;
	...
	public OpenApi32Example createExample() {
		OpenApi32ExampleImpl node = new OpenApi32ExampleImpl();
		node.setParent(this);
		return node;
	}
	...
	@Override
	public OpenApi32SecurityScheme createSecurityScheme() {
		OpenApi32SecuritySchemeImpl node = new OpenApi32SecuritySchemeImpl();
		node.setParent(this);
		return node;
	}
	...
	public void addPathItem(String name, OpenApi32PathItem value) {
		...
		this.pathItems.put(name, value);
		if (value != null) {
			((NodeImpl) value)._setParentPropertyName("pathItems");
			((NodeImpl) value)._setParentPropertyType(ParentPropertyType.map);
			((NodeImpl) value)._setMapPropertyName(name);
		}
	}
	...
	public void insertPathItem(String name, OpenApi32PathItem value, int atIndex) {
		if (this.pathItems == null) {
			...
			this.pathItems = DataModelUtil.insertMapEntry(this.pathItems, name, value, atIndex);
		}
		if (value != null) {
			((NodeImpl) value)._setParentPropertyName("pathItems");
			((NodeImpl) value)._setParentPropertyType(ParentPropertyType.map);
	...
	public void addMediaType(String name, OpenApi32MediaType value) {
		...
		if (value != null) {
			((NodeImpl) value)._setParentPropertyName("mediaTypes");
			((NodeImpl) value)._setParentPropertyType(ParentPropertyType.map);
			((NodeImpl) value)._setMapPropertyName(name);
		}
	}
	...
	public void insertMediaType(String name, OpenApi32MediaType value, int atIndex) {
		if (this.mediaTypes == null) {
			...
			this.mediaTypes = DataModelUtil.insertMapEntry(this.mediaTypes, name, value, atIndex);
		}
		if (value != null) {
			((NodeImpl) value)._setParentPropertyName("mediaTypes");
			((NodeImpl) value)._setParentPropertyType(ParentPropertyType.map);
	...
	public Node emptyClone() {
		return new OpenApi32ComponentsImpl();
	}
}