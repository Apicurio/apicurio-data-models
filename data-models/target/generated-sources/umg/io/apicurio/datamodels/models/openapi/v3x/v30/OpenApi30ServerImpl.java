...
public class OpenApi30ServerImpl extends NodeImpl implements OpenApi30Server {
	...
	@Override
	public OpenApi30ServerVariable createServerVariable() {
		OpenApi30ServerVariableImpl node = new OpenApi30ServerVariableImpl();
		node.setParent(this);
		return node;
	}
	...
	public Node emptyClone() {
		return new OpenApi30ServerImpl();
	}
}