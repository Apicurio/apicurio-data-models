...
public class AsyncApi23ModelWriter implements ModelWriter {
	...
	public void writeDocument(AsyncApi23Document node, ObjectNode json) {
		if (node == null) {
			return;
		}
		...
		JsonUtil.setStringProperty(json, "id", node.getId());
		{
			if (node.getInfo() != null) {
				...
				this.writeInfo((AsyncApi23Info) node.getInfo(), object);
		...
		}
		{
			if (node.getServers() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeServers((AsyncApi23Servers) node.getServers(), object);
		...
		JsonUtil.setStringProperty(json, "defaultContentType", node.getDefaultContentType());
		{
			if (node.getChannels() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeChannels((AsyncApi23Channels) node.getChannels(), object);
		...
		}
		{
			if (node.getComponents() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeComponents((AsyncApi23Components) node.getComponents(), object);
		...
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.forEach(model -> {
					ObjectNode object = JsonUtil.objectNode();
					this.writeTag((AsyncApi23Tag) model, object);
		...
		}
		{
			if (node.getExternalDocs() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeExternalDocumentation((AsyncApi23ExternalDocumentation) node.getExternalDocs(), object);
	...
	public ObjectNode writeRoot(RootNode node) {
		...
		this.writeDocument((AsyncApi23Document) node, json);
		return json;
	}

	public void writeInfo(AsyncApi23Info node, ObjectNode json) {
		if (node == null) {
			return;
		}
		...
		JsonUtil.setStringProperty(json, "termsOfService", node.getTermsOfService());
		{
			if (node.getContact() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeContact((AsyncApi23Contact) node.getContact(), object);
		...
		}
		{
			if (node.getLicense() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeLicense((AsyncApi23License) node.getLicense(), object);
	...
	public void writeContact(AsyncApi23Contact node, ObjectNode json) {
		if (node == null) {
			return;
		}
	...
	public void writeLicense(AsyncApi23License node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "name", node.getName());
	...
	public void writeServers(AsyncApi23Servers node, ObjectNode json) {
		if (node == null) {
			return;
		}
		{
			...
			propertyNames.forEach(propertyName -> {
				ObjectNode object = JsonUtil.objectNode();
				this.writeServer((AsyncApi23Server) node.getItem(propertyName), object);
	...
	public void writeServer(AsyncApi23Server node, ObjectNode json) {
		if (node == null) {
			return;
		}
		...
		JsonUtil.setStringProperty(json, "description", node.getDescription());
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.keySet().forEach(jsonName -> {
					...
					this.writeServerVariable((AsyncApi23ServerVariable) models.get(jsonName), jsonValue);
		...
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.forEach(model -> {
					ObjectNode object = JsonUtil.objectNode();
					this.writeSecurityRequirement((AsyncApi23SecurityRequirement) model, object);
					JsonUtil.addToArray(array, object);
				});
		...
		}
		{
			if (node.getBindings() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeServerBindings((AsyncApi23ServerBindings) node.getBindings(), object);
	...
	public void writeServerVariable(AsyncApi23ServerVariable node, ObjectNode json) {
		if (node == null) {
			return;
		}
	...
	public void writeChannels(AsyncApi23Channels node, ObjectNode json) {
		if (node == null) {
			return;
		}
		{
			...
			propertyNames.forEach(propertyName -> {
				ObjectNode object = JsonUtil.objectNode();
				this.writeChannelItem((AsyncApi23ChannelItem) node.getItem(propertyName), object);
				JsonUtil.setObjectProperty(json, propertyName, object);
			});
		}
		WriterUtil.writeExtraProperties(node, json);
	...
	public void writeChannelItem(AsyncApi23ChannelItem node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "$ref", node.get$ref());
		...
		JsonUtil.setStringArrayProperty(json, "servers", node.getServers());
		{
			if (node.getSubscribe() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeOperation((AsyncApi23Operation) node.getSubscribe(), object);
		...
		}
		{
			if (node.getPublish() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeOperation((AsyncApi23Operation) node.getPublish(), object);
		...
		}
		{
			if (node.getParameters() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeParameters((AsyncApi23Parameters) node.getParameters(), object);
		...
		}
		{
			if (node.getBindings() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeChannelBindings((AsyncApi23ChannelBindings) node.getBindings(), object);
				JsonUtil.setObjectProperty(json, "bindings", object);
			}
		}
		{
	...
	public void writeOperation(AsyncApi23Operation node, ObjectNode json) {
		if (node == null) {
			return;
		}
		...
		}
		{
			if (node.getBindings() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeOperationBindings((AsyncApi23OperationBindings) node.getBindings(), object);
				JsonUtil.setObjectProperty(json, "bindings", object);
			}
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.forEach(model -> {
					ObjectNode object = JsonUtil.objectNode();
					this.writeOperationTrait((AsyncApi23OperationTrait) model, object);
					JsonUtil.addToArray(array, object);
				});
		...
		}
		{
			if (node.getMessage() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeMessage((AsyncApi23Message) node.getMessage(), object);
	...
	public void writeOperationTrait(AsyncApi23OperationTrait node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "$ref", node.get$ref());
	...
	public void writeParameters(AsyncApi23Parameters node, ObjectNode json) {
		if (node == null) {
			return;
		}
		{
			...
			propertyNames.forEach(propertyName -> {
				ObjectNode object = JsonUtil.objectNode();
				this.writeParameter((AsyncApi23Parameter) node.getItem(propertyName), object);
				JsonUtil.setObjectProperty(json, propertyName, object);
			});
		}
		WriterUtil.writeExtraProperties(node, json);
	...
	public void writeParameter(AsyncApi23Parameter node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "$ref", node.get$ref());
		JsonUtil.setStringProperty(json, "description", node.getDescription());
		{
			if (node.getSchema() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeSchema((AsyncApi23Schema) node.getSchema(), object);
	...
	public void writeServerBindings(AsyncApi23ServerBindings node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "$ref", node.get$ref());
		{
			if (node.getHttp() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeBinding((AsyncApi23Binding) node.getHttp(), object);
		...
		}
		{
			if (node.getWs() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeBinding((AsyncApi23Binding) node.getWs(), object);
		...
		}
		{
			if (node.getKafka() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeBinding((AsyncApi23Binding) node.getKafka(), object);
		...
		}
		{
			if (node.getAnypointmq() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeBinding((AsyncApi23Binding) node.getAnypointmq(), object);
		...
		}
		{
			if (node.getAmqp() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeBinding((AsyncApi23Binding) node.getAmqp(), object);
		...
		}
		{
			if (node.getAmqp1() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeBinding((AsyncApi23Binding) node.getAmqp1(), object);
		...
		}
		{
			if (node.getMqtt() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeBinding((AsyncApi23Binding) node.getMqtt(), object);
		...
		}
		{
			if (node.getMqtt5() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeBinding((AsyncApi23Binding) node.getMqtt5(), object);
		...
		}
		{
			if (node.getNats() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeBinding((AsyncApi23Binding) node.getNats(), object);
		...
		}
		{
			if (node.getJms() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeBinding((AsyncApi23Binding) node.getJms(), object);
		...
		}
		{
			if (node.getSns() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeBinding((AsyncApi23Binding) node.getSns(), object);
		...
		}
		{
			if (node.getSolace() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeBinding((AsyncApi23Binding) node.getSolace(), object);
		...
		}
		{
			if (node.getSqs() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeBinding((AsyncApi23Binding) node.getSqs(), object);
		...
		}
		{
			if (node.getStomp() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeBinding((AsyncApi23Binding) node.getStomp(), object);
		...
		}
		{
			if (node.getRedis() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeBinding((AsyncApi23Binding) node.getRedis(), object);
		...
		}
		{
			if (node.getMercure() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeBinding((AsyncApi23Binding) node.getMercure(), object);
		...
		}
		{
			if (node.getIbmmq() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeBinding((AsyncApi23Binding) node.getIbmmq(), object);
	...
	public void writeChannelBindings(AsyncApi23ChannelBindings node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "$ref", node.get$ref());
	...
	public void writeOperationBindings(AsyncApi23OperationBindings node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "$ref", node.get$ref());
	...
	public void writeMessageBindings(AsyncApi23MessageBindings node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "$ref", node.get$ref());
	...
	public void writeOneOfMessages(AsyncApi23OneOfMessages node, ObjectNode json) {
		if (node == null) {
			return;
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.forEach(model -> {
					ObjectNode object = JsonUtil.objectNode();
					this.writeMessage((AsyncApi23Message) model, object);
					JsonUtil.addToArray(array, object);
				});
	...
	public void writeMessage(AsyncApi23Message node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "$ref", node.get$ref());
		...
		}
		{
			if (node.getHeaders() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeSchema((AsyncApi23Schema) node.getHeaders(), object);
		...
		JsonUtil.setAnyProperty(json, "payload", node.getPayload());
		{
			if (node.getCorrelationId() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeCorrelationID((AsyncApi23CorrelationID) node.getCorrelationId(), object);
		...
		}
		{
			if (node.getBindings() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeMessageBindings((AsyncApi23MessageBindings) node.getBindings(), object);
				JsonUtil.setObjectProperty(json, "bindings", object);
			}
		}
		{
			if (node.getExamples() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeMessageExample((AsyncApi23MessageExample) node.getExamples(), object);
		...
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.forEach(model -> {
					ObjectNode object = JsonUtil.objectNode();
					this.writeMessageTrait((AsyncApi23MessageTrait) model, object);
					JsonUtil.addToArray(array, object);
				});
				JsonUtil.setAnyProperty(json, "traits", array);
			}
	...
	public void writeMessageTrait(AsyncApi23MessageTrait node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "$ref", node.get$ref());
	...
	public void writeMessageExample(AsyncApi23MessageExample node, ObjectNode json) {
		if (node == null) {
			return;
		}
	...
	public void writeTag(AsyncApi23Tag node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "name", node.getName());
	...
	public void writeExternalDocumentation(AsyncApi23ExternalDocumentation node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "description", node.getDescription());
	...
	public void writeComponents(AsyncApi23Components node, ObjectNode json) {
		if (node == null) {
			return;
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.keySet().forEach(jsonName -> {
					ObjectNode jsonValue = JsonUtil.objectNode();
					this.writeSchema((AsyncApi23Schema) models.get(jsonName), jsonValue);
					JsonUtil.setObjectProperty(object, jsonName, jsonValue);
				});
		...
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.keySet().forEach(jsonName -> {
					ObjectNode jsonValue = JsonUtil.objectNode();
					this.writeServer((AsyncApi23Server) models.get(jsonName), jsonValue);
					JsonUtil.setObjectProperty(object, jsonName, jsonValue);
				});
				JsonUtil.setObjectProperty(json, "servers", object);
			}
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.keySet().forEach(jsonName -> {
					ObjectNode jsonValue = JsonUtil.objectNode();
					this.writeChannelItem((AsyncApi23ChannelItem) models.get(jsonName), jsonValue);
					JsonUtil.setObjectProperty(object, jsonName, jsonValue);
				});
				JsonUtil.setObjectProperty(json, "channels", object);
			}
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.keySet().forEach(jsonName -> {
					ObjectNode jsonValue = JsonUtil.objectNode();
					this.writeMessage((AsyncApi23Message) models.get(jsonName), jsonValue);
					JsonUtil.setObjectProperty(object, jsonName, jsonValue);
				});
		...
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.keySet().forEach(jsonName -> {
					ObjectNode jsonValue = JsonUtil.objectNode();
					this.writeSecurityScheme((AsyncApi23SecurityScheme) models.get(jsonName), jsonValue);
					JsonUtil.setObjectProperty(object, jsonName, jsonValue);
				});
		...
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.keySet().forEach(jsonName -> {
					ObjectNode jsonValue = JsonUtil.objectNode();
					this.writeParameter((AsyncApi23Parameter) models.get(jsonName), jsonValue);
					JsonUtil.setObjectProperty(object, jsonName, jsonValue);
				});
				JsonUtil.setObjectProperty(json, "parameters", object);
			}
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.keySet().forEach(jsonName -> {
					ObjectNode jsonValue = JsonUtil.objectNode();
					this.writeCorrelationID((AsyncApi23CorrelationID) models.get(jsonName), jsonValue);
					JsonUtil.setObjectProperty(object, jsonName, jsonValue);
				});
		...
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.keySet().forEach(jsonName -> {
					ObjectNode jsonValue = JsonUtil.objectNode();
					this.writeOperationTrait((AsyncApi23OperationTrait) models.get(jsonName), jsonValue);
					JsonUtil.setObjectProperty(object, jsonName, jsonValue);
				});
		...
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.keySet().forEach(jsonName -> {
					ObjectNode jsonValue = JsonUtil.objectNode();
					this.writeMessageTrait((AsyncApi23MessageTrait) models.get(jsonName), jsonValue);
					JsonUtil.setObjectProperty(object, jsonName, jsonValue);
				});
		...
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.keySet().forEach(jsonName -> {
					ObjectNode jsonValue = JsonUtil.objectNode();
					this.writeServerBindings((AsyncApi23ServerBindings) models.get(jsonName), jsonValue);
					JsonUtil.setObjectProperty(object, jsonName, jsonValue);
				});
		...
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.keySet().forEach(jsonName -> {
					ObjectNode jsonValue = JsonUtil.objectNode();
					this.writeChannelBindings((AsyncApi23ChannelBindings) models.get(jsonName), jsonValue);
					JsonUtil.setObjectProperty(object, jsonName, jsonValue);
				});
		...
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.keySet().forEach(jsonName -> {
					ObjectNode jsonValue = JsonUtil.objectNode();
					this.writeOperationBindings((AsyncApi23OperationBindings) models.get(jsonName), jsonValue);
					JsonUtil.setObjectProperty(object, jsonName, jsonValue);
				});
		...
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.keySet().forEach(jsonName -> {
					ObjectNode jsonValue = JsonUtil.objectNode();
					this.writeMessageBindings((AsyncApi23MessageBindings) models.get(jsonName), jsonValue);
					JsonUtil.setObjectProperty(object, jsonName, jsonValue);
				});
	...
	public void writeSchema(AsyncApi23Schema node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "$ref", node.get$ref());
		...
		JsonUtil.setAnyArrayProperty(json, "examples", node.getExamples());
		{
			if (node.getIf() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeSchema((AsyncApi23Schema) node.getIf(), object);
		...
		}
		{
			if (node.getThen() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeSchema((AsyncApi23Schema) node.getThen(), object);
		...
		}
		{
			if (node.getElse() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeSchema((AsyncApi23Schema) node.getElse(), object);
		...
		JsonUtil.setStringMapProperty(json, "patternProperties", node.getPatternProperties());
		{
			...
			if (union != null) {
				...
				if (union.isSchema()) {
					ObjectNode jsonValue = JsonUtil.objectNode();
					this.writeSchema((AsyncApi23Schema) union.asSchema(), jsonValue);
		...
		}
		{
			if (node.getAdditionalItems() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeSchema((AsyncApi23Schema) node.getAdditionalItems(), object);
		...
		}
		{
			...
			if (union != null) {
				...
				if (union.isSchemaList()) {
					...
					models.forEach(model -> {
						ObjectNode object = JsonUtil.objectNode();
						this.writeSchema((AsyncApi23Schema) model, object);
						JsonUtil.addToArray(array, object);
					});
		...
		}
		{
			if (node.getPropertyNames() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeSchema((AsyncApi23Schema) node.getPropertyNames(), object);
		...
		}
		{
			if (node.getContains() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeSchema((AsyncApi23Schema) node.getContains(), object);
		...
		}
		{
			if (node.getNot() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeSchema((AsyncApi23Schema) node.getNot(), object);
	...
	public void writeSecurityScheme(AsyncApi23SecurityScheme node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "$ref", node.get$ref());
		...
		JsonUtil.setStringProperty(json, "bearerFormat", node.getBearerFormat());
		{
			if (node.getFlows() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeOAuthFlows((AsyncApi23OAuthFlows) node.getFlows(), object);
	...
	public void writeOAuthFlows(AsyncApi23OAuthFlows node, ObjectNode json) {
		if (node == null) {
			return;
		}
		{
			if (node.getImplicit() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeOAuthFlow((AsyncApi23OAuthFlow) node.getImplicit(), object);
		...
		}
		{
			if (node.getPassword() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeOAuthFlow((AsyncApi23OAuthFlow) node.getPassword(), object);
		...
		}
		{
			if (node.getClientCredentials() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeOAuthFlow((AsyncApi23OAuthFlow) node.getClientCredentials(), object);
		...
		}
		{
			if (node.getAuthorizationCode() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeOAuthFlow((AsyncApi23OAuthFlow) node.getAuthorizationCode(), object);
	...
	public void writeOAuthFlow(AsyncApi23OAuthFlow node, ObjectNode json) {
		if (node == null) {
			return;
		}
	...
	public void writeSecurityRequirement(AsyncApi23SecurityRequirement node, ObjectNode json) {
		if (node == null) {
			return;
		}
		{
	...
	public void writeCorrelationID(AsyncApi23CorrelationID node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "$ref", node.get$ref());
	...
	public void writeBinding(AsyncApi23Binding node, ObjectNode json) {
		if (node == null) {
			return;
		}
		{
