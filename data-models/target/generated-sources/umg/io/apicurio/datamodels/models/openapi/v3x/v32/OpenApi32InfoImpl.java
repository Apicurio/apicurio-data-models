...
public class OpenApi32InfoImpl extends NodeImpl implements OpenApi32Info {
	...
	@Override
	public OpenApi32Contact createContact() {
		OpenApi32ContactImpl node = new OpenApi32ContactImpl();
		node.setParent(this);
		return node;
	}
	...
	@Override
	public OpenApi32License createLicense() {
		OpenApi32LicenseImpl node = new OpenApi32LicenseImpl();
		node.setParent(this);
		return node;
	}
