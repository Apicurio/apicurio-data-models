...
public class AsyncApi31DocumentImpl extends RootNodeImpl implements AsyncApi31Document {
	...
	public AsyncApi31DocumentImpl() {
		super(ModelType.ASYNCAPI31);
	}
	...
	@Override
	public AsyncApi31Info createInfo() {
		AsyncApi31InfoImpl node = new AsyncApi31InfoImpl();
		node.setParent(this);
		return node;
	}
	...
	@Override
	public AsyncApi31Servers createServers() {
		AsyncApi31ServersImpl node = new AsyncApi31ServersImpl();
		node.setParent(this);
		return node;
	}
	...
	@Override
	public AsyncApi31Channels createChannels() {
		AsyncApi31ChannelsImpl node = new AsyncApi31ChannelsImpl();
		node.setParent(this);
		return node;
	}
	...
	@Override
	public AsyncApi31Operations createOperations() {
		AsyncApi31OperationsImpl node = new AsyncApi31OperationsImpl();
		node.setParent(this);
		return node;
	}
	...
	@Override
	public AsyncApi31Components createComponents() {
		AsyncApi31ComponentsImpl node = new AsyncApi31ComponentsImpl();
		node.setParent(this);
		return node;
	}
	...
	public Node emptyClone() {
		return new AsyncApi31DocumentImpl();
	}
}