...
public class OpenApi32MediaTypeImpl extends NodeImpl implements OpenApi32MediaType {

	private OpenApiSchema schema;
	private OpenApi32Schema itemSchema;
	...
	public void setItemSchema(OpenApi32Schema value) {
		...
		if (value != null) {
			((NodeImpl) value)._setParentPropertyName("itemSchema");
			((NodeImpl) value)._setParentPropertyType(ParentPropertyType.standard);
		}
	}
	...
	@Override
	public OpenApi32Encoding createEncoding() {
		OpenApi32EncodingImpl node = new OpenApi32EncodingImpl();
		node.setParent(this);
		return node;
	}
	...
	public Node emptyClone() {
		return new OpenApi32MediaTypeImpl();
	}
}