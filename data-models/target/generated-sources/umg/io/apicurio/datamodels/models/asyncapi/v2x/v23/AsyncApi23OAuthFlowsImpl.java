...
public class AsyncApi23OAuthFlowsImpl extends NodeImpl implements AsyncApi23OAuthFlows {
	...
	@Override
	public AsyncApi23OAuthFlow createOAuthFlow() {
		AsyncApi23OAuthFlowImpl node = new AsyncApi23OAuthFlowImpl();
		node.setParent(this);
		return node;
	}
	...
	public Node emptyClone() {
		return new AsyncApi23OAuthFlowsImpl();
	}
}