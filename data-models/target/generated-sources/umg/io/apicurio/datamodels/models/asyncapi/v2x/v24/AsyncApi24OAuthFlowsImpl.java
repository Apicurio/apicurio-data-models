...
public class AsyncApi24OAuthFlowsImpl extends NodeImpl implements AsyncApi24OAuthFlows {
	...
	@Override
	public AsyncApi24OAuthFlow createOAuthFlow() {
		AsyncApi24OAuthFlowImpl node = new AsyncApi24OAuthFlowImpl();
		node.setParent(this);
		return node;
	}
	...
	public Node emptyClone() {
		return new AsyncApi24OAuthFlowsImpl();
	}
}