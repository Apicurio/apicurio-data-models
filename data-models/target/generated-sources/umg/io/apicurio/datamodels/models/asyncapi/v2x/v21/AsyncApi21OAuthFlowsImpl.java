...
public class AsyncApi21OAuthFlowsImpl extends NodeImpl implements AsyncApi21OAuthFlows {
	...
	@Override
	public AsyncApi21OAuthFlow createOAuthFlow() {
		AsyncApi21OAuthFlowImpl node = new AsyncApi21OAuthFlowImpl();
		node.setParent(this);
		return node;
	}
	...
	public Node emptyClone() {
		return new AsyncApi21OAuthFlowsImpl();
	}
}