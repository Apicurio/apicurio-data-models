...
public class AsyncApi21InfoImpl extends NodeImpl implements AsyncApi21Info {
	...
	@Override
	public AsyncApi21Contact createContact() {
		AsyncApi21ContactImpl node = new AsyncApi21ContactImpl();
		node.setParent(this);
		return node;
	}
	...
	@Override
	public AsyncApi21License createLicense() {
		AsyncApi21LicenseImpl node = new AsyncApi21LicenseImpl();
		node.setParent(this);
		return node;
	}
