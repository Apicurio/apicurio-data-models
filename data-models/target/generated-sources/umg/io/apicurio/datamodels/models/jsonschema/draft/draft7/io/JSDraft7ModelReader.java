...
import io.apicurio.datamodels.models.jsonschema.draft.draft7.JSDraft7DocumentImpl;
...
public class JSDraft7ModelReader implements ModelReader {

	public void readDocument(ObjectNode json, JSDraft7Document node) {
		{
				...
				keys.forEach(key -> {
					...
					if (value != null) {
						if (JsonUtil.isObject(value)) {
							...
							JSDraft7JSchema model = (JSDraft7JSchema) node.createJSchema();
		...
		}
		{
			...
			if (value != null) {
				if (JsonUtil.isObject(value)) {
					...
					readJSchema(object, (JSDraft7JSchema) node.getNot());
				} else if (JsonUtil.isBoolean(value)) {
					Boolean pValue = JsonUtil.toBoolean(value);
					BooleanUnionValue unionValue = new BooleanUnionValueImpl(pValue);
		...
		}
		{
			...
			if (value != null) {
				if (JsonUtil.isObject(value)) {
					...
					readJSchema(object, (JSDraft7JSchema) node.getIf());
				} else if (JsonUtil.isBoolean(value)) {
					Boolean pValue = JsonUtil.toBoolean(value);
					BooleanUnionValue unionValue = new BooleanUnionValueImpl(pValue);
		...
		}
		{
			...
			if (value != null) {
				if (JsonUtil.isObject(value)) {
					...
					readJSchema(object, (JSDraft7JSchema) node.getThen());
				} else if (JsonUtil.isBoolean(value)) {
					Boolean pValue = JsonUtil.toBoolean(value);
					BooleanUnionValue unionValue = new BooleanUnionValueImpl(pValue);
		...
		}
		{
			...
			if (value != null) {
				if (JsonUtil.isObject(value)) {
					...
					readJSchema(object, (JSDraft7JSchema) node.getElse());
				} else if (JsonUtil.isBoolean(value)) {
					Boolean pValue = JsonUtil.toBoolean(value);
					BooleanUnionValue unionValue = new BooleanUnionValueImpl(pValue);
		...
		}
		{
			...
			if (value != null) {
				if (JsonUtil.isObject(value)) {
					...
					readJSchema(object, (JSDraft7JSchema) node.getItems());
				} else if (JsonUtil.isArray(value)) {
					List<JsonNode> array = JsonUtil.toList(value);
					List<JSDraft7JSchema> models = new ArrayList<>();
					array.forEach(item -> {
		...
		}
		{
			...
			if (value != null) {
				if (JsonUtil.isObject(value)) {
					...
					readJSchema(object, (JSDraft7JSchema) node.getAdditionalItems());
				} else if (JsonUtil.isBoolean(value)) {
					Boolean pValue = JsonUtil.toBoolean(value);
					BooleanUnionValue unionValue = new BooleanUnionValueImpl(pValue);
		...
		}
		{
			...
			if (value != null) {
				if (JsonUtil.isObject(value)) {
					...
					readJSchema(object, (JSDraft7JSchema) node.getContains());
				} else if (JsonUtil.isBoolean(value)) {
					Boolean pValue = JsonUtil.toBoolean(value);
					BooleanUnionValue unionValue = new BooleanUnionValueImpl(pValue);
		...
		}
		{
			...
			if (value != null) {
				if (JsonUtil.isObject(value)) {
					...
					readJSchema(object, (JSDraft7JSchema) node.getAdditionalProperties());
				} else if (JsonUtil.isBoolean(value)) {
					Boolean pValue = JsonUtil.toBoolean(value);
					BooleanUnionValue unionValue = new BooleanUnionValueImpl(pValue);
		...
		}
		{
			...
			if (value != null) {
				if (JsonUtil.isObject(value)) {
					...
					readJSchema(object, (JSDraft7JSchema) node.getPropertyNames());
				} else if (JsonUtil.isBoolean(value)) {
					Boolean pValue = JsonUtil.toBoolean(value);
					BooleanUnionValue unionValue = new BooleanUnionValueImpl(pValue);
	...
	public RootNode readRoot(ObjectNode json) {
		JSDraft7Document rootModel = new JSDraft7DocumentImpl();
		this.readDocument(json, rootModel);
		return rootModel;
	}

	public void readJSchema(ObjectNode json, JSDraft7JSchema node) {
		{
