...
public class AsyncApi30OperationBindingsImpl extends NodeImpl implements AsyncApi30OperationBindings {
	...
	public AsyncApi30Binding createBinding() {
		AsyncApi30BindingImpl node = new AsyncApi30BindingImpl();
		node.setParent(this);
		return node;
	}
	...
	public Node emptyClone() {
		return new AsyncApi30OperationBindingsImpl();
	}
}