...
public class OpenRpc13ModelWriter implements ModelWriter {

	public void writeDocument(OpenRpc13Document node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "openrpc", node.getOpenrpc());
		{
			if (node.getInfo() != null) {
				...
				this.writeInfo((OpenRpc13Info) node.getInfo(), object);
		...
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.forEach(model -> {
					ObjectNode object = JsonUtil.objectNode();
					this.writeServer((OpenRpc13Server) model, object);
		...
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.forEach(model -> {
					ObjectNode object = JsonUtil.objectNode();
					this.writeMethod((OpenRpc13Method) model, object);
					JsonUtil.addToArray(array, object);
				});
		...
		}
		{
			if (node.getComponents() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeComponents((OpenRpc13Components) node.getComponents(), object);
		...
		}
		{
			if (node.getExternalDocs() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeExternalDocumentation((OpenRpc13ExternalDocumentation) node.getExternalDocs(), object);
	...
	public ObjectNode writeRoot(RootNode node) {
		...
		this.writeDocument((OpenRpc13Document) node, json);
		return json;
	}

	public void writeInfo(OpenRpc13Info node, ObjectNode json) {
		if (node == null) {
			return;
		}
		...
		JsonUtil.setStringProperty(json, "termsOfService", node.getTermsOfService());
		{
			if (node.getContact() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeContact((OpenRpc13Contact) node.getContact(), object);
		...
		}
		{
			if (node.getLicense() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeLicense((OpenRpc13License) node.getLicense(), object);
	...
	public void writeContact(OpenRpc13Contact node, ObjectNode json) {
		if (node == null) {
			return;
		}
	...
	public void writeLicense(OpenRpc13License node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "name", node.getName());
	...
	public void writeServer(OpenRpc13Server node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "name", node.getName());
		...
		JsonUtil.setStringProperty(json, "description", node.getDescription());
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.keySet().forEach(jsonName -> {
					...
					this.writeServerVariable((OpenRpc13ServerVariable) models.get(jsonName), jsonValue);
	...
	public void writeServerVariable(OpenRpc13ServerVariable node, ObjectNode json) {
		if (node == null) {
			return;
		}
	...
	public void writeMethod(OpenRpc13Method node, ObjectNode json) {
		if (node == null) {
			return;
		}
		...
		JsonUtil.setStringProperty(json, "name", node.getName());
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.forEach(model -> {
					ObjectNode object = JsonUtil.objectNode();
					this.writeTag((OpenRpc13Tag) model, object);
					JsonUtil.addToArray(array, object);
				});
		...
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.forEach(model -> {
					ObjectNode object = JsonUtil.objectNode();
					this.writeContentDescriptor((OpenRpc13ContentDescriptor) model, object);
					JsonUtil.addToArray(array, object);
				});
		...
		}
		{
			if (node.getResult() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeContentDescriptor((OpenRpc13ContentDescriptor) node.getResult(), object);
		...
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.forEach(model -> {
					ObjectNode object = JsonUtil.objectNode();
					this.writeError((OpenRpc13Error) model, object);
					JsonUtil.addToArray(array, object);
				});
		...
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.forEach(model -> {
					ObjectNode object = JsonUtil.objectNode();
					this.writeLink((OpenRpc13Link) model, object);
					JsonUtil.addToArray(array, object);
				});
		...
		JsonUtil.setStringProperty(json, "paramStructure", node.getParamStructure());
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.forEach(model -> {
					ObjectNode object = JsonUtil.objectNode();
					this.writeExamplePairing((OpenRpc13ExamplePairing) model, object);
					JsonUtil.addToArray(array, object);
				});
	...
	public void writeContentDescriptor(OpenRpc13ContentDescriptor node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "$ref", node.get$ref());
		...
		JsonUtil.setBooleanProperty(json, "deprecated", node.isDeprecated());
		{
			if (node.getSchema() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeSchema((OpenRpc13Schema) node.getSchema(), object);
	...
	public void writeSchema(OpenRpc13Schema node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "$ref", node.get$ref());
		...
		JsonUtil.setAnyArrayProperty(json, "examples", node.getExamples());
		{
			if (node.getIf() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeSchema((OpenRpc13Schema) node.getIf(), object);
		...
		}
		{
			if (node.getThen() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeSchema((OpenRpc13Schema) node.getThen(), object);
		...
		}
		{
			if (node.getElse() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeSchema((OpenRpc13Schema) node.getElse(), object);
		...
		JsonUtil.setBooleanProperty(json, "writeOnly", node.isWriteOnly());
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.keySet().forEach(jsonName -> {
					ObjectNode jsonValue = JsonUtil.objectNode();
					this.writeSchema((OpenRpc13Schema) models.get(jsonName), jsonValue);
					JsonUtil.setObjectProperty(object, jsonName, jsonValue);
				});
		...
		JsonUtil.setStringMapProperty(json, "patternProperties", node.getPatternProperties());
		{
			...
			if (union != null) {
				...
				if (union.isSchema()) {
					ObjectNode jsonValue = JsonUtil.objectNode();
					this.writeSchema((OpenRpc13Schema) union.asSchema(), jsonValue);
		...
		}
		{
			if (node.getAdditionalItems() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeSchema((OpenRpc13Schema) node.getAdditionalItems(), object);
		...
		}
		{
			...
			if (union != null) {
				...
				if (union.isSchemaList()) {
					...
					models.forEach(model -> {
						ObjectNode object = JsonUtil.objectNode();
						this.writeSchema((OpenRpc13Schema) model, object);
						JsonUtil.addToArray(array, object);
					});
		...
		}
		{
			if (node.getPropertyNames() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeSchema((OpenRpc13Schema) node.getPropertyNames(), object);
		...
		}
		{
			if (node.getContains() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeSchema((OpenRpc13Schema) node.getContains(), object);
		...
		}
		{
			if (node.getNot() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeSchema((OpenRpc13Schema) node.getNot(), object);
	...
	public void writeExamplePairing(OpenRpc13ExamplePairing node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "$ref", node.get$ref());
		...
		JsonUtil.setStringProperty(json, "summary", node.getSummary());
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.forEach(model -> {
					ObjectNode object = JsonUtil.objectNode();
					this.writeExample((OpenRpc13Example) model, object);
					JsonUtil.addToArray(array, object);
				});
				JsonUtil.setAnyProperty(json, "params", array);
			}
		}
		{
			if (node.getResult() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeExample((OpenRpc13Example) node.getResult(), object);
				JsonUtil.setObjectProperty(json, "result", object);
			}
		}
		{
	...
	public void writeExample(OpenRpc13Example node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "$ref", node.get$ref());
	...
	public void writeLink(OpenRpc13Link node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "$ref", node.get$ref());
		...
		JsonUtil.setAnyProperty(json, "params", node.getParams());
		{
			if (node.getServer() != null) {
				ObjectNode object = JsonUtil.objectNode();
				this.writeServer((OpenRpc13Server) node.getServer(), object);
	...
	public void writeError(OpenRpc13Error node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "$ref", node.get$ref());
	...
	public void writeComponents(OpenRpc13Components node, ObjectNode json) {
		if (node == null) {
			return;
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.keySet().forEach(jsonName -> {
					ObjectNode jsonValue = JsonUtil.objectNode();
					this.writeContentDescriptor((OpenRpc13ContentDescriptor) models.get(jsonName), jsonValue);
					JsonUtil.setObjectProperty(object, jsonName, jsonValue);
				});
		...
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.keySet().forEach(jsonName -> {
					ObjectNode jsonValue = JsonUtil.objectNode();
					this.writeExample((OpenRpc13Example) models.get(jsonName), jsonValue);
					JsonUtil.setObjectProperty(object, jsonName, jsonValue);
				});
		...
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.keySet().forEach(jsonName -> {
					ObjectNode jsonValue = JsonUtil.objectNode();
					this.writeLink((OpenRpc13Link) models.get(jsonName), jsonValue);
					JsonUtil.setObjectProperty(object, jsonName, jsonValue);
				});
		...
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.keySet().forEach(jsonName -> {
					ObjectNode jsonValue = JsonUtil.objectNode();
					this.writeError((OpenRpc13Error) models.get(jsonName), jsonValue);
					JsonUtil.setObjectProperty(object, jsonName, jsonValue);
				});
		...
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.keySet().forEach(jsonName -> {
					ObjectNode jsonValue = JsonUtil.objectNode();
					this.writeExamplePairing((OpenRpc13ExamplePairing) models.get(jsonName), jsonValue);
					JsonUtil.setObjectProperty(object, jsonName, jsonValue);
				});
		...
		}
		{
			...
			if (models != null && !models.isEmpty()) {
				...
				models.keySet().forEach(jsonName -> {
					ObjectNode jsonValue = JsonUtil.objectNode();
					this.writeTag((OpenRpc13Tag) models.get(jsonName), jsonValue);
					JsonUtil.setObjectProperty(object, jsonName, jsonValue);
				});
	...
	public void writeTag(OpenRpc13Tag node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "$ref", node.get$ref());
	...
	public void writeExternalDocumentation(OpenRpc13ExternalDocumentation node, ObjectNode json) {
		if (node == null) {
			return;
		}
		JsonUtil.setStringProperty(json, "description", node.getDescription());
