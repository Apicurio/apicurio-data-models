...
public class AsyncApi30OAuthFlowsImpl extends NodeImpl implements AsyncApi30OAuthFlows {
	...
	@Override
	public AsyncApi30OAuthFlow createOAuthFlow() {
		AsyncApi30OAuthFlowImpl node = new AsyncApi30OAuthFlowImpl();
		node.setParent(this);
		return node;
	}
	...
	public Node emptyClone() {
		return new AsyncApi30OAuthFlowsImpl();
	}
}