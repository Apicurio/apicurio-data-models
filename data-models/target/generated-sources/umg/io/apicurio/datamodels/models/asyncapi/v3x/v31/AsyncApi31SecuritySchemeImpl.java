...
public class AsyncApi31SecuritySchemeImpl extends NodeImpl implements AsyncApi31SecurityScheme {
	...
	@Override
	public AsyncApi31OAuthFlows createOAuthFlows() {
		AsyncApi31OAuthFlowsImpl node = new AsyncApi31OAuthFlowsImpl();
		node.setParent(this);
		return node;
	}
	...
	public Node emptyClone() {
		return new AsyncApi31SecuritySchemeImpl();
	}
}