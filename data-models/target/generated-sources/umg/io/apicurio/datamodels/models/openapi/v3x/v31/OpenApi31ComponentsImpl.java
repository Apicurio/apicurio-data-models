...
public class OpenApi31ComponentsImpl extends NodeImpl implements OpenApi31Components {
	...
	private Map<String, OpenApi31PathItem> pathItems;
	...
	public OpenApi31RequestBody createRequestBody() {
		OpenApi31RequestBodyImpl node = new OpenApi31RequestBodyImpl();
		node.setParent(this);
		return node;
	}
	...
	@Override
	public OpenApi31SecurityScheme createSecurityScheme() {
		OpenApi31SecuritySchemeImpl node = new OpenApi31SecuritySchemeImpl();
		node.setParent(this);
		return node;
	}
	...
	public OpenApi31Callback createCallback() {
		OpenApi31CallbackImpl node = new OpenApi31CallbackImpl();
		node.setParent(this);
		return node;
	}
	...
	public Node emptyClone() {
		return new OpenApi31ComponentsImpl();
	}
}