...
public class OpenApi20InfoImpl extends NodeImpl implements OpenApi20Info {
	...
	@Override
	public OpenApi20Contact createContact() {
		OpenApi20ContactImpl node = new OpenApi20ContactImpl();
		node.setParent(this);
		return node;
	}
	...
	@Override
	public OpenApi20License createLicense() {
		OpenApi20LicenseImpl node = new OpenApi20LicenseImpl();
		node.setParent(this);
		return node;
	}
