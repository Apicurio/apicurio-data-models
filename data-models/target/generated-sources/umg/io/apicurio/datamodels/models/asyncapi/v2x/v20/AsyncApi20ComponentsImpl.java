...
public class AsyncApi20ComponentsImpl extends NodeImpl implements AsyncApi20Components {
	...
	@Override
	public AsyncApi20SecurityScheme createSecurityScheme() {
		AsyncApi20SecuritySchemeImpl node = new AsyncApi20SecuritySchemeImpl();
		node.setParent(this);
		return node;
	}
	...
	@Override
	public AsyncApi20OperationTrait createOperationTrait() {
		AsyncApi20OperationTraitImpl node = new AsyncApi20OperationTraitImpl();
		node.setParent(this);
		return node;
	}
	...
	@Override
	public AsyncApi20OperationBindings createOperationBindings() {
		AsyncApi20OperationBindingsImpl node = new AsyncApi20OperationBindingsImpl();
		node.setParent(this);
		return node;
	}
	...
	public Node emptyClone() {
		return new AsyncApi20ComponentsImpl();
	}
}