...
public class AsyncApi20OAuthFlowsImpl extends NodeImpl implements AsyncApi20OAuthFlows {
	...
	@Override
	public AsyncApi20OAuthFlow createOAuthFlow() {
		AsyncApi20OAuthFlowImpl node = new AsyncApi20OAuthFlowImpl();
		node.setParent(this);
		return node;
	}
	...
	public Node emptyClone() {
		return new AsyncApi20OAuthFlowsImpl();
	}
}