...
public class OpenApi31InfoImpl extends NodeImpl implements OpenApi31Info {
	...
	@Override
	public OpenApi31Contact createContact() {
		OpenApi31ContactImpl node = new OpenApi31ContactImpl();
		node.setParent(this);
		return node;
	}
	...
	@Override
	public OpenApi31License createLicense() {
		OpenApi31LicenseImpl node = new OpenApi31LicenseImpl();
		node.setParent(this);
		return node;
	}
