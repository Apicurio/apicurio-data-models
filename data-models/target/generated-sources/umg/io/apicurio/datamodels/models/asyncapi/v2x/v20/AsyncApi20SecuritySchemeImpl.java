...
public class AsyncApi20SecuritySchemeImpl extends NodeImpl implements AsyncApi20SecurityScheme {
	...
	@Override
	public AsyncApi20OAuthFlows createOAuthFlows() {
		AsyncApi20OAuthFlowsImpl node = new AsyncApi20OAuthFlowsImpl();
		node.setParent(this);
		return node;
	}
	...
	public Node emptyClone() {
		return new AsyncApi20SecuritySchemeImpl();
	}
}