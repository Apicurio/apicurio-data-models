...
public class AsyncApi23SecuritySchemeImpl extends NodeImpl implements AsyncApi23SecurityScheme {
	...
	@Override
	public AsyncApi23OAuthFlows createOAuthFlows() {
		AsyncApi23OAuthFlowsImpl node = new AsyncApi23OAuthFlowsImpl();
		node.setParent(this);
		return node;
	}
	...
	public Node emptyClone() {
		return new AsyncApi23SecuritySchemeImpl();
	}
}