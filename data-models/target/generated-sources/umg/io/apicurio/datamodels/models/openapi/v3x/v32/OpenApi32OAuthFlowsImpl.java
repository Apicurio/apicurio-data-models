...
public class OpenApi32OAuthFlowsImpl extends NodeImpl implements OpenApi32OAuthFlows {

	private OAuthFlow implicit;
	private OAuthFlow password;
	private OAuthFlow clientCredentials;
	private OAuthFlow authorizationCode;
	private OpenApi32OAuthFlow deviceAuthorization;
	...
	public OpenApi32OAuthFlow createOAuthFlow() {
		OpenApi32OAuthFlowImpl node = new OpenApi32OAuthFlowImpl();
		node.setParent(this);
		return node;
	}
	...
	public void setDeviceAuthorization(OpenApi32OAuthFlow value) {
		this.deviceAuthorization = value;
		if (value != null) {
			((NodeImpl) value)._setParentPropertyName("deviceAuthorization");
			((NodeImpl) value)._setParentPropertyType(ParentPropertyType.standard);
		}
	}
	...
	public Node emptyClone() {
		return new OpenApi32OAuthFlowsImpl();
	}
}