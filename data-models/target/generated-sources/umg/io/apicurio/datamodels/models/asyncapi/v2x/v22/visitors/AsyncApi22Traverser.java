...
public class AsyncApi22Traverser extends AbstractTraverser implements AsyncApi22Visitor {
	...
	public void visitOneOfMessages(AsyncApiOneOfMessages node) {
		node.accept(this.visitor);
		AsyncApi22OneOfMessages model = (AsyncApi22OneOfMessages) node;
	...
	public void visitChannelItem(AsyncApiChannelItem node) {
		node.accept(this.visitor);
		AsyncApi22ChannelItem model = (AsyncApi22ChannelItem) node;
	...
	public void visitMessageBindings(AsyncApiMessageBindings node) {
		node.accept(this.visitor);
		AsyncApi22MessageBindings model = (AsyncApi22MessageBindings) node;
	...
	public void visitOperationBindings(AsyncApiOperationBindings node) {
		node.accept(this.visitor);
		AsyncApi22OperationBindings model = (AsyncApi22OperationBindings) node;
		this.traverseNode("http", model.getHttp());
		this.traverseNode("ws", model.getWs());
		this.traverseNode("kafka", model.getKafka());
		this.traverseNode("anypointmq", model.getAnypointmq());
	...
	public void visitComponents(Components node) {
		node.accept(this.visitor);
		AsyncApi22Components model = (AsyncApi22Components) node;
	...
	public void visitParameter(Parameter node) {
		node.accept(this.visitor);
		AsyncApi22Parameter model = (AsyncApi22Parameter) node;
	...
	public void visitChannelBindings(AsyncApiChannelBindings node) {
		node.accept(this.visitor);
		AsyncApi22ChannelBindings model = (AsyncApi22ChannelBindings) node;
		this.traverseNode("http", model.getHttp());
		this.traverseNode("ws", model.getWs());
		this.traverseNode("kafka", model.getKafka());
		this.traverseNode("anypointmq", model.getAnypointmq());
	...
	public void visitParameters(AsyncApiParameters node) {
		node.accept(this.visitor);
		AsyncApi22Parameters model = (AsyncApi22Parameters) node;
	...
	public void visitMessage(AsyncApiMessage node) {
		node.accept(this.visitor);
		AsyncApi22Message model = (AsyncApi22Message) node;
		this.traverseList("oneOf", model.getOneOf());
	...
	public void visitOperationTrait(AsyncApiOperationTrait node) {
		node.accept(this.visitor);
		AsyncApi22OperationTrait model = (AsyncApi22OperationTrait) node;
		this.traverseList("tags", model.getTags());
		this.traverseNode("externalDocs", model.getExternalDocs());
		this.traverseNode("bindings", model.getBindings());
	}
	...
	public void visitServer(Server node) {
		node.accept(this.visitor);
		AsyncApi22Server model = (AsyncApi22Server) node;
	...
	public void visitOAuthFlows(OAuthFlows node) {
		node.accept(this.visitor);
		AsyncApi22OAuthFlows model = (AsyncApi22OAuthFlows) node;
	...
	public void visitSchema(Schema node) {
		node.accept(this.visitor);
		AsyncApi22Schema model = (AsyncApi22Schema) node;
	...
	public void visitServerBindings(AsyncApiServerBindings node) {
		node.accept(this.visitor);
		AsyncApi22ServerBindings model = (AsyncApi22ServerBindings) node;
		this.traverseNode("http", model.getHttp());
		this.traverseNode("ws", model.getWs());
		this.traverseNode("kafka", model.getKafka());
		this.traverseNode("anypointmq", model.getAnypointmq());
	...
	public void visitServers(AsyncApiServers node) {
		node.accept(this.visitor);
		AsyncApi22Servers model = (AsyncApi22Servers) node;
		this.traverseMappedNode(model);
	}
	...
	public void visitChannels(AsyncApiChannels node) {
		node.accept(this.visitor);
		AsyncApi22Channels model = (AsyncApi22Channels) node;
		this.traverseMappedNode(model);
	}
	...
	public void visitTag(Tag node) {
		node.accept(this.visitor);
		AsyncApi22Tag model = (AsyncApi22Tag) node;
		this.traverseNode("externalDocs", model.getExternalDocs());
	}
	...
	public void visitInfo(Info node) {
		node.accept(this.visitor);
		AsyncApi22Info model = (AsyncApi22Info) node;
	...
	public void visitOperation(Operation node) {
		node.accept(this.visitor);
		AsyncApi22Operation model = (AsyncApi22Operation) node;
		this.traverseList("tags", model.getTags());
		this.traverseNode("externalDocs", model.getExternalDocs());
		this.traverseNode("bindings", model.getBindings());
		this.traverseList("traits", model.getTraits());
	...
	public void visitMessageTrait(AsyncApiMessageTrait node) {
		node.accept(this.visitor);
		AsyncApi22MessageTrait model = (AsyncApi22MessageTrait) node;
		this.traverseNode("headers", model.getHeaders());
		this.traverseNode("correlationId", model.getCorrelationId());
		this.traverseList("tags", model.getTags());
		this.traverseNode("externalDocs", model.getExternalDocs());
	...
	public void visitSecurityScheme(SecurityScheme node) {
		node.accept(this.visitor);
		AsyncApi22SecurityScheme model = (AsyncApi22SecurityScheme) node;
	...
	public void visitDocument(Document node) {
		node.accept(this.visitor);
		AsyncApi22Document model = (AsyncApi22Document) node;
