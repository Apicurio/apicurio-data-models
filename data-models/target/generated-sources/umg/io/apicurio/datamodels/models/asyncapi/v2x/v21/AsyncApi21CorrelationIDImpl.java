...
public class AsyncApi21CorrelationIDImpl extends NodeImpl implements AsyncApi21CorrelationID {
	...
	public void accept(Visitor visitor) {
		...
		viz.visitCorrelationID(this);
	}

	@Override
	public Node emptyClone() {
		return new AsyncApi21CorrelationIDImpl();
	}
}