...
public class AsyncApi22SecuritySchemeImpl extends NodeImpl implements AsyncApi22SecurityScheme {
	...
	@Override
	public AsyncApi22OAuthFlows createOAuthFlows() {
		AsyncApi22OAuthFlowsImpl node = new AsyncApi22OAuthFlowsImpl();
		node.setParent(this);
		return node;
	}
	...
	public Node emptyClone() {
		return new AsyncApi22SecuritySchemeImpl();
	}
}