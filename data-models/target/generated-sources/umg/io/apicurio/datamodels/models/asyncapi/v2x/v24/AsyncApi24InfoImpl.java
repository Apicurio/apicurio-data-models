...
public class AsyncApi24InfoImpl extends NodeImpl implements AsyncApi24Info {
	...
	@Override
	public AsyncApi24Contact createContact() {
		AsyncApi24ContactImpl node = new AsyncApi24ContactImpl();
		node.setParent(this);
		return node;
	}
	...
	@Override
	public AsyncApi24License createLicense() {
		AsyncApi24LicenseImpl node = new AsyncApi24LicenseImpl();
		node.setParent(this);
		return node;
	}
