...
public class AsyncApi26OperationBindingsImpl extends NodeImpl implements AsyncApi26OperationBindings {

	private String $ref;
	private AsyncApiBinding http;
	private AsyncApiBinding ws;
	private AsyncApiBinding kafka;
	private AsyncApi26Binding anypointmq;
	...
	private AsyncApi26Binding solace;
	private AsyncApiBinding sqs;
	private AsyncApiBinding stomp;
	private AsyncApiBinding redis;
	private AsyncApi26Binding mercure;
	private AsyncApi26Binding ibmmq;
	private AsyncApi26Binding googlepubsub;
	private AsyncApi26Binding pulsar;
	...
	public AsyncApi26Binding createBinding() {
		AsyncApi26BindingImpl node = new AsyncApi26BindingImpl();
		node.setParent(this);
		return node;
	}
	...
	public Node emptyClone() {
		return new AsyncApi26OperationBindingsImpl();
	}
}