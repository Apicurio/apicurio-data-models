...
public class AsyncApi23InfoImpl extends NodeImpl implements AsyncApi23Info {
	...
	@Override
	public AsyncApi23Contact createContact() {
		AsyncApi23ContactImpl node = new AsyncApi23ContactImpl();
		node.setParent(this);
		return node;
	}
	...
	@Override
	public AsyncApi23License createLicense() {
		AsyncApi23LicenseImpl node = new AsyncApi23LicenseImpl();
		node.setParent(this);
		return node;
	}
