...
import io.apicurio.datamodels.models.jsonschema.modern.v202012.JS202012DocumentImpl;
...
public class JS202012ModelReader implements ModelReader {

	public void readDocument(ObjectNode json, JS202012Document node) {
		{
		...
		{
			String value = JsonUtil.consumeStringProperty(json, "$dynamicRef");
			node.set$dynamicRef(value);
		}
		{
			String value = JsonUtil.consumeStringProperty(json, "$dynamicAnchor");
			node.set$dynamicAnchor(value);
		}
		{
				...
				keys.forEach(key -> {
					...
					if (value != null) {
						if (JsonUtil.isObject(value)) {
							...
							JS202012JSchema model = (JS202012JSchema) node.createJSchema();
		...
		}
		{
			...
			if (value != null) {
				if (JsonUtil.isObject(value)) {
					...
					readJSchema(object, (JS202012JSchema) node.getNot());
				} else if (JsonUtil.isBoolean(value)) {
					Boolean pValue = JsonUtil.toBoolean(value);
					BooleanUnionValue unionValue = new BooleanUnionValueImpl(pValue);
		...
		}
		{
			...
			if (value != null) {
				if (JsonUtil.isObject(value)) {
					...
					readJSchema(object, (JS202012JSchema) node.getIf());
				} else if (JsonUtil.isBoolean(value)) {
					Boolean pValue = JsonUtil.toBoolean(value);
					BooleanUnionValue unionValue = new BooleanUnionValueImpl(pValue);
		...
		}
		{
			...
			if (value != null) {
				if (JsonUtil.isObject(value)) {
					...
					readJSchema(object, (JS202012JSchema) node.getThen());
				} else if (JsonUtil.isBoolean(value)) {
					Boolean pValue = JsonUtil.toBoolean(value);
					BooleanUnionValue unionValue = new BooleanUnionValueImpl(pValue);
		...
		}
		{
			...
			if (value != null) {
				if (JsonUtil.isObject(value)) {
					...
					readJSchema(object, (JS202012JSchema) node.getElse());
				} else if (JsonUtil.isBoolean(value)) {
					Boolean pValue = JsonUtil.toBoolean(value);
					BooleanUnionValue unionValue = new BooleanUnionValueImpl(pValue);
		...
		}
		{
			...
			if (value != null) {
				if (JsonUtil.isObject(value)) {
					...
					readJSchema(object, (JS202012JSchema) node.getContentSchema());
				} else if (JsonUtil.isBoolean(value)) {
					Boolean pValue = JsonUtil.toBoolean(value);
					BooleanUnionValue unionValue = new BooleanUnionValueImpl(pValue);
		...
		{
			List<JsonNode> array = JsonUtil.consumeAnyArrayProperty(json, "prefixItems");
			if (array != null) {
				array.forEach(value -> {
					if (JsonUtil.isObject(value)) {
						ObjectNode object = JsonUtil.toObject(value);
						JS202012JSchema model = (JS202012JSchema) node.createJSchema();
						readJSchema(object, model);
						node.addPrefixItem(model);
					} else if (JsonUtil.isBoolean(value)) {
						Boolean pValue = JsonUtil.toBoolean(value);
						BooleanUnionValue unionValue = new BooleanUnionValueImpl(pValue);
						node.addPrefixItem(unionValue);
					}
				});
			}
		}
		{
			...
			if (value != null) {
				if (JsonUtil.isObject(value)) {
					...
					readJSchema(object, (JS202012JSchema) node.getItems());
				} else if (JsonUtil.isBoolean(value)) {
					Boolean pValue = JsonUtil.toBoolean(value);
					BooleanUnionValue unionValue = new BooleanUnionValueImpl(pValue);
		...
		}
		{
			...
			if (value != null) {
				if (JsonUtil.isObject(value)) {
					...
					readJSchema(object, (JS202012JSchema) node.getContains());
				} else if (JsonUtil.isBoolean(value)) {
					Boolean pValue = JsonUtil.toBoolean(value);
					BooleanUnionValue unionValue = new BooleanUnionValueImpl(pValue);
		...
		}
		{
			...
			if (value != null) {
				if (JsonUtil.isObject(value)) {
					...
					readJSchema(object, (JS202012JSchema) node.getUnevaluatedItems());
				} else if (JsonUtil.isBoolean(value)) {
					Boolean pValue = JsonUtil.toBoolean(value);
					BooleanUnionValue unionValue = new BooleanUnionValueImpl(pValue);
		...
		}
		{
			...
			if (value != null) {
				if (JsonUtil.isObject(value)) {
					...
					readJSchema(object, (JS202012JSchema) node.getAdditionalProperties());
				} else if (JsonUtil.isBoolean(value)) {
					Boolean pValue = JsonUtil.toBoolean(value);
					BooleanUnionValue unionValue = new BooleanUnionValueImpl(pValue);
		...
		}
		{
			...
			if (value != null) {
				if (JsonUtil.isObject(value)) {
					...
					readJSchema(object, (JS202012JSchema) node.getPropertyNames());
				} else if (JsonUtil.isBoolean(value)) {
					Boolean pValue = JsonUtil.toBoolean(value);
					BooleanUnionValue unionValue = new BooleanUnionValueImpl(pValue);
		...
		}
		{
			...
			if (value != null) {
				if (JsonUtil.isObject(value)) {
					...
					readJSchema(object, (JS202012JSchema) node.getUnevaluatedProperties());
				} else if (JsonUtil.isBoolean(value)) {
					Boolean pValue = JsonUtil.toBoolean(value);
					BooleanUnionValue unionValue = new BooleanUnionValueImpl(pValue);
	...
	public RootNode readRoot(ObjectNode json) {
		JS202012Document rootModel = new JS202012DocumentImpl();
		this.readDocument(json, rootModel);
		return rootModel;
	}

	public void readJSchema(ObjectNode json, JS202012JSchema node) {
		{
