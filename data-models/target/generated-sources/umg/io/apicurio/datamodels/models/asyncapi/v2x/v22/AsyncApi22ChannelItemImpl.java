...
public class AsyncApi22ChannelItemImpl extends NodeImpl implements AsyncApi22ChannelItem {
	...
	@Override
	public AsyncApi22Operation createOperation() {
		AsyncApi22OperationImpl node = new AsyncApi22OperationImpl();
		node.setParent(this);
		return node;
	}
	...
	@Override
	public AsyncApi22Parameters createParameters() {
		AsyncApi22ParametersImpl node = new AsyncApi22ParametersImpl();
		node.setParent(this);
		return node;
	}
	...
	public Node emptyClone() {
		return new AsyncApi22ChannelItemImpl();
	}
}