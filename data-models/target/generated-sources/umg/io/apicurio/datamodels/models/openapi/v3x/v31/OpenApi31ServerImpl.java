...
public class OpenApi31ServerImpl extends NodeImpl implements OpenApi31Server {
	...
	@Override
	public OpenApi31ServerVariable createServerVariable() {
		OpenApi31ServerVariableImpl node = new OpenApi31ServerVariableImpl();
		node.setParent(this);
		return node;
	}
	...
	public Node emptyClone() {
		return new OpenApi31ServerImpl();
	}
}