...
/**
 * Implements the Invalid Operation Trait Reference rule for AsyncAPI.
 * @author eric.wittmann@gmail.com
 */
public class AaInvalidOperationTraitReferenceRule extends ValidationRule {

    /**
     * Constructor.
     * @param ruleInfo
     */
    public AaInvalidOperationTraitReferenceRule(ValidationRuleMetaData ruleInfo) {
        super(ruleInfo);
    }
