...
/**
 * Implements the Invalid Error Reference rule for OpenRPC.
 * @author eric.wittmann@gmail.com
 */
public class OrpcInvalidErrorReferenceRule extends ValidationRule {

    /**
     * Constructor.
     * @param ruleInfo
     */
    public OrpcInvalidErrorReferenceRule(ValidationRuleMetaData ruleInfo) {
        super(ruleInfo);
    }
