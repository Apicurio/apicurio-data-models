...
public class OasInvalidHttpResponseCodeRule extends OasInvalidPropertyNameRule {
     ...
     * @param ruleInfo
     */
    public OasInvalidHttpResponseCodeRule(ValidationRuleMetaData ruleInfo) {
        super(ruleInfo);
    }

    /**
     * @see io.apicurio.datamodels.models.visitors.CombinedVisitorAdapter#visitResponse(io.apicurio.datamodels.models.openapi.OpenApiResponse)
     */
    @Override
    public void visitResponse(OpenApiResponse node) {
        ...
        if (hasValue(statusCode) && !equals(statusCode, "default")) {
            this.reportIfInvalid(isValidHttpCode(statusCode), node, "statusCode", map("statusCode", statusCode));
        }
    }
