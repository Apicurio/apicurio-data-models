...
/**
 * Implements the Invalid Link Reference rule for OpenRPC.
 * @author eric.wittmann@gmail.com
 */
public class OrpcInvalidLinkReferenceRule extends ValidationRule {

    /**
     * Constructor.
     * @param ruleInfo
     */
    public OrpcInvalidLinkReferenceRule(ValidationRuleMetaData ruleInfo) {
        super(ruleInfo);
    }
